...
S_nsep = generateData(100,0,15,5,20,0,15,5,20)
...
# wop2, convPocket, t2 = Pocket(S_nsep, w0, 500, hyperplan, visualize= True)
# print("w.T =", wop2,"| Ls(w) =", convPocket, "| t =", t2)

wop3, convAdaline, t3 = adaline(S_nsep, w0, 100, hyperplan, visualize=True)
